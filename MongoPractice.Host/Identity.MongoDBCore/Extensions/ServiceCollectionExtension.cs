...
namespace Identity.MongoDBCore.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtension
    {
        ...
        private static void ValidateMongoDbSettings(MongoDbSettings mongoDbSettings)
        {
            ...
            if (string.IsNullOrEmpty(mongoDbSettings.MongoConnection))
            {
                throw new ArgumentNullException(nameof(mongoDbSettings.MongoConnection));
            }

            if (string.IsNullOrEmpty(mongoDbSettings.DataBase))
            {
                throw new ArgumentNullException(nameof(mongoDbSettings.DataBase));
            }
        }
            ...
            if(mongoDbContext == null)
            {
                services.AddIdentity<TUser, TRole>()
                        .AddMongoDbStores<TUser, TRole, TKey>(
                            mongoDbIdentityConfiguration.MongoDbSettings.MongoConnection,
                            mongoDbIdentityConfiguration.MongoDbSettings.DataBase)
